...
export default async function Top({invoice}) {
            ...
            <div className={"col-span-3"} id={"head"}>
                <div className={"flex justify-between"}>
                    <div className={"flex-col"}>
                        <h1 className={"text-lg font-normal text-gray-600 drop-shadow-sm"}>{data.companyName}</h1>
                        <div className={"flex items-end flex-1"}><h1 className={"text-7xl font-bold"}>INVOICE</h1> <span
                    ...
                    <div className={"basis-1/3 flex-col justify-center"}>
                        <div
                            ...
                            <p className={"text-6xl font-light tracking-tightest text-gray-600 drop-shadow-lg"}>{data.logoLetters}</p></div>
