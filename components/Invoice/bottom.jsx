        ...
        <div className={"col-span-3"}>
            ...
            <div className={"flex py-4 justify-center"}>
                ...
                <p className={"uppercase text-lg font-bold mt-auto mb-2.5"}>
                    choosing EXALTED DEVELOPMENT for your project.
                </p>
            </div>
            ...
            <div className={"flex justify-around pt-16 pb-4"}>
                <div className={"basis-1/2 text-center"}>
                    ...
                    <ul className={"text-start ml-16 mt-4 space-y-2"}>
                        <li className={"flex"}><p className={"text-lg font-bold"}>Phone:</p><span className={"flex-1 h-[1px] bg-gray-200 mt-auto mb-1.5 mx-1"}></span><p className={"mr-16"}>+1 (715) 321-3386</p></li>
                ...
                <div className={"basis-1/2 text-center"}>
                    ...
                    <ul className={" text-center mt-4 font-thin tracking-tight space-y-2"}>
                        <li><p className={"italic"}>Late payments are subject to a 5% fee per week</p></li>
                        <li><p className={"-indent-3"}>Payments accepted via cash, check, or card.</p></li>
                        <li><p className={"-indent-3"}>Payment due <b>within 1 week of receipt.</b></p></li>
                    </ul>
                </div>
            </div>
