...
import ClientContext from "@/components/contextSetters/ClientContext";

// Fetch Data
const getData = async () => {
    const res = await fetch('https://invoicer.pockethost.io/api/collections/clients/records?sort=+company&expand=invoices')
...
export default async function RootLayout({children}) {
    ...
    const navigation = [
        {name: 'View All', icon: QueueListIcon, href: '/', current: true},
        {name: 'Create', icon: PlusIcon, href: '/create', current: true},
    ]
    ...
    return (
        ...
        <div className={"basis-1/12"}>
            ...
            <div
                className="flex flex-grow flex-col overflow-y-auto border-r border-gray-200 bg-white pt-5 pb-4 min-h-screen">
